...
// boundary doing its job rather than a nuisance. Everything below is upstream's,
// and still says something true: what reaches the contract is a `uint256` that
// came through `onchainIdentity`.
const PLAYER = 255n;
